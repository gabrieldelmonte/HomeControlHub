 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ad;function ym(){return Ad||(Ad=1,function(o){function l(A,J){var U=A.length;A.push(J);e:for(;0<U;){var x=U-1>>>1,z=A[x];if(0<f(z,J))A[x]=J,A[U]=z,U=x;else break e}}function a(A){return A.length===0?null:A[0]}function c(A){if(A.length===0)return null;var J=A[0],U=A.pop();if(U!==J){A[0]=U;e:for(var x=0,z=A.length,re=z>>>1;x<re;){var oe=2*(x+1)-1,ae=A[oe],le=oe+1,he=A[le];if(0>f(ae,U))le<z&&0>f(he,ae)?(A[x]=he,A[le]=U,x=le):(A[x]=ae,A[oe]=U,x=oe);else if(le<z&&0>f(he,U))A[x]=he,A[le]=U,x=le;else break e}}return J}function f(A,J){var U=A.sortIndex-J.sortIndex;return U!==0?U:A.id-J.id}if(typeof performance=="object"&&typeof performance.now=="function"){var h=performance;o.unstable_now=function(){return h.now()}}else{var m=Date,w=m.now();o.unstable_now=function(){return m.now()-w}}var y=[],P=[],_=1,E=null,N=3,$=!1,M=!1,R=!1,D=typeof setTimeout=="function"?setTimeout:null,G=typeof clearTimeout=="function"?clearTimeout:null,H=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(A){for(var J=a(P);J!==null;){if(J.callback===null)c(P);else if(J.startTime<=A)c(P),J.sortIndex=J.expirationTime,l(y,J);else break;J=a(P)}}function q(A){if(R=!1,b(A),!M)if(a(y)!==null)M=!0,Ue(Z);else{var J=a(P);J!==null&&ye(q,J.startTime-A)}}function Z(A,J){M=!1,R&&(R=!1,G(ve),ve=-1),$=!0;var U=N;try{for(b(J),E=a(y);E!==null&&(!(E.expirationTime>J)||A&&!$t());){var x=E.callback;if(typeof x=="function"){E.callback=null,N=E.priorityLevel;var z=x(E.expirationTime<=J);J=o.unstable_now(),typeof z=="function"?E.callback=z:E===a(y)&&c(y),b(J)}else c(y);E=a(y)}if(E!==null)var re=!0;else{var oe=a(P);oe!==null&&ye(q,oe.startTime-J),re=!1}return re}finally{E=null,N=U,$=!1}}var V=!1,K=null,ve=-1,Qe=5,xt=-1;function $t(){return!(o.unstable_now()-xt<Qe)}function ct(){if(K!==null){var A=o.unstable_now();xt=A;var J=!0;try{J=K(!0,A)}finally{J?Ye():(V=!1,K=null)}}else V=!1}var Ye;if(typeof H=="function")Ye=function(){H(ct)};else if(typeof MessageChannel<"u"){var ot=new MessageChannel,dt=ot.port2;ot.port1.onmessage=ct,Ye=function(){dt.postMessage(null)}}else Ye=function(){D(ct,0)};function Ue(A){K=A,V||(V=!0,Ye())}function ye(A,J){ve=D(function(){A(o.unstable_now())},J)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(A){A.callback=null},o.unstable_continueExecution=function(){M||$||(M=!0,Ue(Z))},o.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Qe=0<A?Math.floor(1e3/A):5},o.unstable_getCurrentPriorityLevel=function(){return N},o.unstable_getFirstCallbackNode=function(){return a(y)},o.unstable_next=function(A){switch(N){case 1:case 2:case 3:var J=3;break;default:J=N}var U=N;N=J;try{return A()}finally{N=U}},o.unstable_pauseExecution=function(){},o.unstable_requestPaint=function(){},o.unstable_runWithPriority=function(A,J){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var U=N;N=A;try{return J()}finally{N=U}},o.unstable_scheduleCallback=function(A,J,U){var x=o.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?x+U:x):U=x,A){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=U+z,A={id:_++,callback:J,priorityLevel:A,startTime:U,expirationTime:z,sortIndex:-1},U>x?(A.sortIndex=U,l(P,A),a(y)===null&&A===a(P)&&(R?(G(ve),ve=-1):R=!0,ye(q,U-x))):(A.sortIndex=z,l(y,A),M||$||(M=!0,Ue(Z))),A},o.unstable_shouldYield=$t,o.unstable_wrapCallback=function(A){var J=N;return function(){var U=N;N=J;try{return A.apply(this,arguments)}finally{N=U}}}}(pa)),pa}var Md;function xm(){return Md||(Md=1,fa.exports=ym()),fa.exports}/**
 * @license React
...
`,e1=C.div`
  ...
  font-size: 0.875rem;
  text-align: center;
`,Sf=()=>{const o=Xt(),[l,a]=T.useState({email:"",password:""}),[c,f]=T.useState(!1),[h,m]=T.useState(""),[w,y]=T.useState(""),[P,_]=T.useState(!1);T.useEffect(()=>(localStorage.removeItem("token"),document.body.classList.add("auth-page"),()=>{document.body.classList.remove("auth-page")}),[]);const E=G=>{const{name:H,value:b}=G.target;a(q=>({...q,[H]:b})),h&&m("")},N=G=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(G),$=()=>!l.email||!l.password?(m("Email and password are required"),!1):N(l.email)?l.password.length<6?(m("Password must be at least 6 characters long"),!1):!0:(m("Please enter a valid email address"),!1),M=()=>l.email.trim()!==""&&l.password.trim()!==""&&N(l.email)&&l.password.length>=6,R=async G=>{if(G.preventDefault(),m(""),y(""),!!$()){_(!0);try{const H=await fetch("/api/v1/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.email,password:l.password})});if(H.ok){const b=await H.json();localStorage.setItem("token",b.token),localStorage.setItem("user",JSON.stringify(b.user)),y("Login successful!"),setTimeout(()=>{o("/dashboard")},1e3)}else{const b=await H.json();m(b.message||"Login failed. Please check your credentials.")}}catch(H){console.error("Login error:",H),m("Unable to connect to server. Please try again later.")}finally{_(!1)}}},D=()=>{m(""),y("Password reset functionality coming soon.")};return u.jsx(Mg,{children:u.jsxs(Ug,{children:[u.jsxs(Bg,{children:[u.jsxs(Hg,{children:[u.jsx(Wg,{children:"🏠"}),"Home Control Hub"]}),u.jsx(vf,{children:"Welcome back!"}),u.jsx(vf,{children:"Please log in to access your smart home dashboard."})]}),u.jsxs(Vg,{children:[u.jsxs(Qg,{children:[u.jsx(Yg,{children:"Login"}),h&&u.jsx(Zg,{children:h}),w&&u.jsx(e1,{children:w}),u.jsxs("form",{onSubmit:R,children:[u.jsxs(yf,{children:[u.jsx(xf,{htmlFor:"email",children:"Your email"}),u.jsx(wf,{type:"email",id:"email",name:"email",value:l.email,onChange:E,placeholder:"Enter your email",required:!0})]}),u.jsxs(yf,{children:[u.jsxs(xf,{htmlFor:"password",children:["Your password",u.jsxs(Kg,{type:"button",onClick:()=>f(!c),children:[c?u.jsx(tl,{}):u.jsx(nl,{}),u.jsx("span",{children:"Show"})]})]}),u.jsx(Gg,{children:u.jsx(wf,{type:c?"text":"password",id:"password",name:"password",value:l.password,onChange:E,placeholder:"Enter your password",required:!0})})]}),u.jsx(qg,{type:"submit",disabled:P,isComplete:M(),children:P?"Please wait...":"Log in"}),u.jsx(Xg,{onClick:D,children:"Forget your password?"})]})]}),u.jsx(Jg,{as:Wf,to:"/register",children:"Create an account"})]})]})})},t1=C.div`
  display: flex;
  height: 100vh;
  min-height: 100vh;
  width: 100vw;
...
`,$1=["Login Issue","Device Not Responding","Billing Question","Feature Request","Other"],b1=()=>{const[o,l]=T.useState(""),[a,c]=T.useState(""),[f,h]=T.useState(""),[m,w]=T.useState(null),[y,P]=T.useState(!1),_=Xt(),E=R=>{l(R.target.value),R.target.value!=="Other"&&c("")},N=R=>{w(R.target.files)},$=R=>{R.preventDefault(),P(!0)},M=()=>{localStorage.removeItem("token"),_("/login")};return u.jsxs(Sn,{children:[u.jsxs(kn,{children:[u.jsxs(jn,{children:[u.jsx(Cn,{children:"🏠"}),u.jsx(En,{children:"Home Control Hub"})]}),u.jsxs(Pn,{children:[u.jsx(pe,{onClick:()=>_("/profile"),children:"Profile"}),u.jsx(pe,{onClick:()=>_("/dashboard"),children:"Dashboard"}),u.jsx(pe,{onClick:()=>_("/faq"),children:"FAQ"}),u.jsx(pe,{selected:!0,onClick:()=>_("/support"),children:"Support"}),u.jsx(_n,{onClick:M,children:"Logout"})]})]}),u.jsxs(zn,{children:[u.jsx(Ua,{children:"Contact Support"}),u.jsxs(N1,{onSubmit:$,children:[u.jsxs(xa,{children:[u.jsx(wa,{htmlFor:"subject",children:"Subject"}),u.jsxs(L1,{id:"subject",value:o,onChange:E,required:!0,children:[u.jsx("option",{value:"",disabled:!0,children:"Select a subject"}),$1.map(R=>u.jsx("option",{value:R,children:R},R))]}),o==="Other"&&u.jsx(R1,{type:"text",placeholder:"Enter your subject",value:a,onChange:R=>c(R.target.value),required:!0})]}),u.jsxs(xa,{children:[u.jsx(wa,{htmlFor:"message",children:"Describe your problem"}),u.jsx(T1,{id:"message",value:f,onChange:R=>h(R.target.value),required:!0,rows:7})]}),u.jsxs(xa,{children:[u.jsx(wa,{children:"Attach files (optional)"}),u.jsx(O1,{type:"file",multiple:!0,onChange:N}),m&&m.length>0&&u.jsx(I1,{children:Array.from(m).map((R,D)=>u.jsx("li",{children:R.name},D))})]}),u.jsx(D1,{type:"submit",disabled:f.trim()==="",children:"Send"}),y&&u.jsx(F1,{children:"Your message has been sent! Our support team will contact you soon."})]})]})]})},A1=C.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  margin-bottom: 2rem;
